...
export function PebbleHero({
  ...
  const stageCardClass = theme === 'dark'
    ? 'border-[rgba(193,209,236,0.42)] bg-[linear-gradient(154deg,rgba(31,43,69,0.99)_0%,rgba(22,31,54,0.995)_54%,rgba(15,23,43,0.998)_100%)] shadow-[0_38px_92px_rgba(0,3,13,0.64),inset_0_1px_0_rgba(228,238,255,0.11)]'
    : 'border-[rgba(140,163,203,0.74)] bg-[linear-gradient(152deg,rgba(237,244,255,0.998)_0%,rgba(228,238,254,0.999)_56%,rgba(220,233,250,1)_100%)] shadow-[0_30px_74px_rgba(53,77,118,0.24),inset_0_1px_0_rgba(255,255,255,0.94)]'
  ...
  const previewStoryClass = theme === 'dark'
    ? 'border-pebble-accent/18 bg-[linear-gradient(180deg,rgba(59,130,246,0.10)_0%,rgba(255,255,255,0.02)_100%)]'
    : 'border-pebble-accent/20 bg-[linear-gradient(180deg,rgba(59,130,246,0.08)_0%,rgba(255,255,255,0.7)_100%)]'
