                ...
                {!isExpanded && (
                    <div
                        ...
                        className={[
                            ...
                            'rounded-xl border border-pebble-border/30 bg-pebble-panel/95 backdrop-blur-xl',
            ...
            {isExpanded && (
                <div
                    className={[
                        ...
                        'rounded-xl border border-pebble-border/30 bg-pebble-panel/70 backdrop-blur-xl',
                        'shadow-[0_4px_16px_rgba(2,8,23,0.12)] px-3',
                    ].join(' ')}
                >
                    {/* Time digits */}
                    <span
                        className="font-mono text-sm font-semibold tabular-nums text-pebble-text-primary min-w-[52px] text-center"
                        aria-live="polite"
                        aria-atomic="true"
                    >
                        {formatTime(displayMs)}
                    ...
                    <button
                        ...
                        className={[
                            'inline-flex items-center justify-center rounded-lg px-2.5 h-6 text-xs font-semibold transition',
                    ...
                    <button
                        ...
                        disabled={!hasElapsed}
                        className={[
                            'inline-flex items-center justify-center rounded-lg px-2 h-6 text-xs font-medium transition',
