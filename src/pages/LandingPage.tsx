  ...
  const valueCards = [
    {
      ...
      copy: t('landing.why1Copy'),
    },
    {
      title: t('landing.why2Title'),
      copy: t('landing.why2Copy'),
    },
    {
      title: t('landing.why3Title'),
      copy: t('landing.why3Copy'),
    },
  ]

  return (
    <section dir={isRTL ? 'rtl' : 'ltr'} className="page-enter space-y-7">
            ...
            <div className="mt-3 space-y-3">
              ...
              <div className="rounded-xl border border-pebble-border/30 bg-pebble-overlay/[0.08] p-3">
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-xs font-semibold text-pebble-text-primary">{t('landing.previewCoach')}</p>
                </div>
      ...
      <Card padding="md" className="space-y-4" interactive>
        <div className="space-y-1">
          <h2 className="text-2xl font-semibold tracking-[-0.015em] text-pebble-text-primary">{t('landing.howTitle')}</h2>
          <p className="text-sm text-pebble-text-secondary">{t('landing.howSubtitle')}</p>
        </div>
      ...
      <Card padding="md" className="space-y-4" interactive>
        <div className="space-y-1">
          <h2 className="text-2xl font-semibold tracking-[-0.015em] text-pebble-text-primary">{t('landing.whyTitle')}</h2>
          <p className="text-sm text-pebble-text-secondary">{t('landing.whySubtitle')}</p>
        </div>
        <div className="grid gap-3 sm:grid-cols-3">
          {valueCards.map((card) => (
